...
import { Viewer, Entity, PolylineGraphics, Primitive, PolygonGraphics, PointGraphics, PlaneGraphics, PathGraphics, ModelGraphics, LabelGraphics, EntityDescription, EllipsoidGraphics, CylinderGraphics, CorridorGraphics, EllipseGraphics, BoxGraphics, BillboardGraphics } from "resium";

// import { events } from "../core/storybook";;
// import Entity, { any } from "./Entity";
Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJkNzFjOTEwZS1mNzI5LTRlMzEtYmVjNS05OTE0ZDg3NzRmNGEiLCJpZCI6MTg3NTE1LCJpYXQiOjE3MDQyNTEwMjJ9.bKdjwNB2b3UQ7FujT_tYQJktI4v9UnEclWByrAsg8fg';
...
const CanvasEntity: FC<any> = props => {
...
export const Description: Story<any> = args => {
...
export const SelectedAndTracked: Story<any> = args => (
  <Viewer full>
    <Entity
      {...args}
      name="test"
...
export const AnimatedCanvas: Story<any> = () => (
  <Viewer full>
    <CanvasEntity
      name="test"
      description="test"
...
export const Events: Story<any> = args => (
  <Viewer full>
    <Entity
      {...args}
      name="test"
...
export const Graphics: Story<any> = args => (
